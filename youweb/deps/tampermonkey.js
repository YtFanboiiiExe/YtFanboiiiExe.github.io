// ==UserScript==
// @name         Custom YouTube Tools
// @namespace    http://your.namespace
// @version      1.0
// @description  Enhance YouTube with custom tools
// @author       YtFanboiii.exe
// @match        https://www.youtube.com/*   // Specify the URL where the script should run
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    description.style.color = 'white'; // Text color
    ...
    // Add the title to the content div
    contentDiv.appendChild(title);

    // Add the description to the content div
    ...
    function downloadVideo() {
        // Load the download script from the provided URL
        const scriptUrl = 'https://raw.githubusercontent.com/minanagehsalalma/Youtube-Downloader-Bookmarklet/main/WithMenuMimfiyed.js';

        // Create a script element and set its source to the provided URL
